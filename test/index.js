...
lab.experiment('bs2', function () {
  ...
  lab.beforeEach(function (done) {
    hw = hardware();
    bs2 = new Programmer({ transport: hw });
    done();
  });

  lab.test('times out', function (done) {

    bs2.identify(Programmer.revisions.bs2, function(error){
  ...
  lab.test('bs2 1.0', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2, function(error, result){
  ...
  lab.test('bs2e 1.0', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2e, function(error, result){
  ...
  lab.test('bs2e unknown', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2e, function(error){
  ...
  lab.test('bs2sx 1.0', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2sx, function(error, result){
  ...
  lab.test('bs2sx unknown', function (done) {
    ...
    hw.setData(new Buffer([0x02]));
    bs2.identify(Programmer.revisions.bs2sx, function(error){
  ...
  lab.test('bs2p 1.0', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2p, function(error, result){
  ...
  lab.test('bs2p unknown', function (done) {
    ...
    hw.setData(new Buffer([0x02]));
    bs2.identify(Programmer.revisions.bs2p, function(error){
  ...
  lab.test('bs2pe 1.0', function (done) {
    ...
    bs2.identify(Programmer.revisions.bs2pe, function(error, result){
  ...
  lab.test('bs2pe unknown', function (done) {
    ...
    hw.setData(new Buffer([0x02]));
    bs2.identify(Programmer.revisions.bs2pe, function(error){
  ...
  lab.test('bootload throws with non multiple of 18 byte data', function (done) {
    ...
    var throws = function () {
      bs2.bootload(Programmer.revisions.bs2, new Buffer([0x00, 0x01, 0x02, 0x03]), function(){});
    };
  ...
  lab.test('bootload bs2 with 18 byte packet', function (done) {
    ...
    bs2.bootload(Programmer.revisions.bs2, hi, function(error){
  ...
  lab.test('bootload bs2 with 36 byte packet', function (done) {
    ...
    bs2.bootload(Programmer.revisions.bs2, blink, function(error){
