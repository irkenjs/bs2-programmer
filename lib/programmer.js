...
Programmer.prototype.enterProgramming = function(cb){
  var protocol = this._protocol;

  var promise = protocol.reset();
  return nodefn.bindCallback(promise, cb);
};

Programmer.prototype.exitProgramming = function(cb){
  var protocol = this._protocol;

  var promise = protocol.signoff();
  return nodefn.bindCallback(promise, cb);
};
